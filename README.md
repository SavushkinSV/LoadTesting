...
__Проведение тестирования.__ Это этап выполнения тестовых сценариев под нагрузкой. Здесь важно контролировать параметры тестирования и анализировать результаты.

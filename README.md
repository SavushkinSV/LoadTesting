...
__Поиск максимальной производительности__ По результатам тестирования определяется максимальный уровень производительности, при котором система соответствует требованиям, предъявляемым к ней в части
...
На первом этапе. Нагрузка подается ступенчато. Определяется L0. Также может быть определена Lпик. Предыдущая ступень от L0 – предполагаемый максимум.
...
На втором этапе. Нагрузка подается на одном уровне предполагаемого Lmax, с плавным выходом на него. Во время теста не должно наблюдаться роста времен отклика, утечки памяти или других изменений, так как нагрузка стабильна.

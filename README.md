...
На втором этапе. Нагрузка подается на одном уровне предполагаемого __Lmax__, с плавным выходом на него. Во время теста не должно наблюдаться роста времен отклика, утечки памяти или других изменений, так как нагрузка стабильна.

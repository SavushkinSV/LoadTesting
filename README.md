...
1. [Обзор средств мониторинга](#обзор-средств-мониторинга)
2. [Метрики, собираемые во время нагрузочного тестирования (классификация и примеры наиболее важных)](#метрики-собираемые-во-время-нагрузочного-тестирования)
...
- Выбор периода сбора статистики

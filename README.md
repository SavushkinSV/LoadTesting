...
6. [Анализ архитектуры систем](#анализ-архитектуры-систем) \
  ...
  6.6 [Двузхвенная и трехзвенная архитектура](#двузхвенная-и-трехзвенная-архитектура) \
...
8. [Обзор средств мониторинга (Prometheus+Grafana, Telegraf+InfluxDB+Grafana)](#обзор-средств-мониторинга)
...
__Стрессовое тестирование (Stress Testing).__ Проводят, чтобы проверить работоспособность системы при огромных нагрузках — больших, чем ожидается в обычных условиях. Это важно в том числе для определения максимальных нагрузок. Проводится проверка способности системы к самовосстановлению после стрессовой нагрузки на нее. В частности, определяется, за какое время происходит это восстановление.
...
__Доступность (Availability)__ — процент времени, в течение которого система доступна для использования. Измеряется как отношение времени безотказной работы к общему времени.
...
__Надёжность (Reliability)__ — способность системы сохранять работоспособность при длительных нагрузках. Измеряется временем между сбоями или количеством успешных операций до сбоя.

__Масштабируемость (Scalability)__ — способность системы увеличивать производительность при добавлении ресурсов (например, процессоров или памяти).

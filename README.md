...
__Durability (надежность)__ — беспечивает сохранность данных после успешной транзакции. Это означает, что после подтверждения транзакции изменения данных сохраняются и не будут потеряны даже в случае сбоя системы.

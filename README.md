...
3. [Введение в методологию нагрузочного тестирования](#введение-в-методологию-нагрузочного-тестирования) \
  ...
  3.9 [Проверка масштабируемости](#) \
  3.10 [Объемное тестирование](#)
...
1.  [Введение в заглушки](#)
    - Определение и назначение
    - Плюсы и минусы использования
    - Обзор инструментов и фрейворков
2.  [Создание отчетов НТ](#)
3.  [Основы программирования](#основы-программирования)
    - [Парадигмы ООП](#парадигмы-ооп)
    - [Классы и объекты](#классы-и-объекты)
4.  Garbage Collection и JVM
5.  Самопредставление
  О себе

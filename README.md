...
Для корреляции в JMeter испльзуются: Boundary Extractor, CSS Selector Extractor, JSR223 PostProcessor.
...
Для верификации в JMeter испльзуются: Response Assertion.
